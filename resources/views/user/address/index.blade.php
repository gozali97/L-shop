...
<title>{{ Helper::getSetting()->brand_name }} - Comment</title>
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Address Lists</h6>
        <a href="{{route('user.address.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Address</a>
    </div>
    <div class="card-body">
