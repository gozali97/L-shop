...
@endsection
@section('title', Helper::getSetting()->brand_name . ' - Product Detail')
									...
									<div class="col-lg-6 col-12">
										...
										<div class="product-gallery">
											...
											<div class="flexslider-thumbnails">
												<ul class="slides">
													@php
														$photoImg=explode(',',$product_detail->photo);
													// dd($photo);
													@endphp
													@foreach($photoImg as $data)
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">Rp. {{number_format($after_discount)}}</span> </p>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	You need to <a href="{{route('login')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{route('register.form')}}">Register</a>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
											@php
												$photoImg=explode(',',$data->photo);
											@endphp
                                            <img class="default-img" src="{{$photo}}" alt="{{$data->title}}">
                                            <img class="hover-img" src="{{$photo}}" alt="{{$data->title}}">
