<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin') }}">
        <div class="sidebar-brand-icon rotate-n-15">
            ...
            <img src="{{ Helper::getBrandLogoUrl() }}" width="50px" class="img-fluid zoom" style="max-width:80px"
                alt="{{Helper::getSetting()->brand_name}}">
        </div>
    ...
    {{-- Brands --}}
    <li class="nav-item {{ Route::is('brand.*') ? 'active' : '' }}">
    ...
    {{-- Shipping --}}
    <li class="nav-item {{ Route::is('shipping.*') ? 'active' : '' }}">
    ...
    <!-- Reviews -->
    <li class="nav-item {{ Route::is('review.*') ? 'active' : '' }}">
    ...
    <!-- Category -->
    <li class="nav-item {{ Route::is('post-category.*') ? 'active' : '' }}">
    ...
    <!-- Tags -->
    <li class="nav-item {{ Route::is('post-tag.*') ? 'active' : '' }}">
    ...
    <!-- Comments -->
    <li class="nav-item {{ Route::is('comment.*') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ Route::is('coupon.*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('coupon.index') }}">
            ...
            <span>Coupon</span></a>
                ...
                <!-- Bank -->
        <li class="nav-item {{ Route::is('bank.*') ? 'active' : '' }}">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#bankAccountCollapse"
                aria-expanded="true" aria-controls="bankAccountCollapse">
                <i class="fas fa-credit-card"></i>
                <span>Bank Accounts</span>
            </a>
            <div id="bankAccountCollapse" class="collapse" aria-labelledby="bankAccount"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Bank Account Options:</h6>
                    <a class="collapse-item" href="{{ route('bank.index') }}">Bank Account</a>
                    <a class="collapse-item" href="{{ route('bank.create') }}">Add Bank Account</a>
                </div>
            </div>
        </li>
        <!-- Users -->
