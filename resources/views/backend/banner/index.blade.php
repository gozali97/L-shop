...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">App Sliders List</h6>
      <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add App Sliders</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($banners as $banner)
                <tr>
                    ...
                    <td>
                        @if($banner->photo)
                            <img src="{{$photo[$loop->index]}}" class="img-fluid zoom" style="max-width:80px" alt="{{$banner->photo}}">
                        @else
