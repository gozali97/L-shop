        ...
        <div class="mx-auto max-w-md">
            <div class="divide-y divide-gray-300/50">
                <div class="space-y-6 py-8 text-base leading-7 text-gray-600">
                    ...
                    <h3 class="font-bold text-xl">Your Payment Success Received</h3>
                    <div class="flex flex-row">
                        <a href="{{ route('user.order.show', $order->id ?? 1) }}"
                           class="color-primary-button text-white px-2 rounded font-semibold">View Order</a>
                        <p class="ml-2">or</p>
                        <a href="{{ env('APP_URL') }}" class="ml-2 link">Visit our website</a>
                    </div>
                    <h5 class="font-semibold text-lg">Order Summary</h5>
                    <p class="font-medium text-lg">Berikut No resi Anda: <br>
                        {{$data->no_resi}}</p>
                    ...
                    <div class="flex w-full justify-center justify-items-center gap-4">
                        <a target="_blank" href="{{ route('about-us') }}"
                           class="text-white font-semibold color-primary-button px-2 rounded">About Us</a>
                        <a target="_blank" href="{{ env('APP_URL') }}"
                           class="text-white font-semibold color-primary-button px-2 rounded">Our Store</a>
                    </div>
