...
<head>
    <title>Detail Shipping Refund Order Received</title>
        ...
        <div class="mx-auto max-w-md">
            <div class="divide-y divide-gray-300/50">
                <div class="space-y-6 py-8 text-base leading-7 text-gray-600">
                    ...
                    <h3 class="font-bold text-xl">Refund Shipping Order Received</h3>
                    <div class="flex flex-row">
                        <a href="{{ route('order.show', $order->id ?? 1) }}" class="color-primary-button text-white px-2 rounded font-semibold">View Order</a>
                        <p class="ml-2">or</p>
                        <a href="{{ env('APP_URL') }}" class="ml-2 link">Visit our website</a>
                    </div>
                    <div class="flex flex-col w-full">
                        <h5>Detail Shipping Refund : </h5>
                      <p>Courir : {{ucwords($shipping->type)}}</p>
                      <p>No Resi : {{$shipping->no_resi}}</p>
                    </div>
